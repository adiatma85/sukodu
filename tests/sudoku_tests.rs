use sukodu::{
    format_board, generate_board, has_unique_solution, make_lines_cols, parse_grid, solve_board,
};
...
fn run_scenario(size: usize, difficulty: &str) {
    ...
    println!(
        "Size {}x{} ({}) generated with {} clues",
        size, size, difficulty, clues_count
    );
...
#[ignore]
fn test_16x16_easy() {
    run_scenario(16, "easy");
}
#[test]
#[ignore]
fn test_16x16_medium() {
    run_scenario(16, "medium");
}
#[test]
#[ignore]
fn test_16x16_hard() {
    run_scenario(16, "hard");
}
...
#[ignore]
fn test_25x25_easy() {
    run_scenario(25, "easy");
}
#[test]
#[ignore]
fn test_25x25_medium() {
    run_scenario(25, "medium");
}
#[test]
#[ignore]
fn test_25x25_hard() {
    run_scenario(25, "hard");
}
...
#[ignore]
fn test_36x36_easy() {
    run_scenario(36, "easy");
}
#[test]
#[ignore]
fn test_36x36_medium() {
    run_scenario(36, "medium");
}
#[test]
#[ignore]
fn test_36x36_hard() {
    run_scenario(36, "hard");
}
...
#[ignore]
fn test_49x49_easy() {
    run_scenario(49, "easy");
}
#[test]
#[ignore]
fn test_49x49_medium() {
    run_scenario(49, "medium");
}
#[test]
#[ignore]
fn test_49x49_hard() {
    run_scenario(49, "hard");
}
